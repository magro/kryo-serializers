...
public class MiniMapSerializerTest {
    ...
    public void testMiniMapEmpty() {
        ...
        final MiniMap<?, ?> deserialized = KryoUtils.deserialize(_kryo, serialized, MiniMap.class);
    ...
    public void testMiniMapAddEntriesAfterDeserialization() {
        ...
        final MiniMap<String, String> deserialized = KryoUtils.deserialize(_kryo, serialized, MiniMap.class);
        Assert.assertEquals( deserialized.size(), obj.size() );        
